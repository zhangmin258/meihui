...
function rushbuyGoto(obj){
	var dataId = obj.getAttribute("dataId");                  //商品id
	var limitId= obj.getAttribute("limitId");              //限时抢购id
	store.set('dataId',dataId);
	store.set('limitId',limitId);
	var mnhtitleText = obj.getAttribute("dataname");		
